...
This question asks for CLINICAL EVIDENCE. Use search_evidence to ground a pattern in published literature; cite only returned PMIDs. Use recall first to anchor on the personal pattern being grounded.
