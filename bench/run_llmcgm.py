...
QUESTIONS: dict[str, tuple[str, str, str]] = {
    ...
    "Q3": ("What was the standard deviation of my glucose (mg/dL)?", "Q3_std", "num"),
    ...
    "Q6": ("What percent of time was I above range (above 180 mg/dL)?", "Q6_TAR180_pct", "pct"),
    ...
    "Q9": ("What percent of time was I above 250 mg/dL?", "Q9_TAR250_pct", "pct"),
    "Q10": ("What is my estimated A1C?", "Q10_eA1c", "num"),
    "Q11": ("What percent of time was I below 54 mg/dL?", "Q11_TBR54_pct", "pct"),
    "Q12": ("What time of day was my blood glucose highest?", "Q12_highest_time", "hour"),
    "Q14": ("What time of day was my blood glucose lowest?", "Q14_lowest_time", "hour"),
